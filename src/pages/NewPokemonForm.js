...
function NewPokemonForm() {
	...
	const errorStyle = (fieldError) =>
		fieldError
			? {
					background: "rgb(255,60,87)",
					background: "linear-gradient(90deg, rgba(255,60,87,1) 0%, rgba(53,53,53,1) 2%)",
					color: "#fff",
			  }
			: {};

	const onSubmit = (data) => {
		setMessage(`Your Pokemon ${data.basePokemonName} has been created in ${data.region} region!`);
	};
		...
		<>
			...
			<section className="center container">
				<div className="form-wrapper">
					<h2>
						Explore the wonders of <span className="green">nature</span> and craft your unique{" "}
						<span className="red">Pokémon!</span>
					</h2>
					<form onSubmit={handleSubmit(onSubmit)}>
						<div className="input-wrapper">
							...
							<input
								type="text"
								{...register("basePokemonName", { required: "Base Name required", maxLength: 20 })}
						...
						<div className="input-wrapper">
							...
							<input
								type="text"
								{...register("evoTwoName", { required: "Name required", maxLength: 20 })}
						...
						<div className="input-wrapper">
							...
							<input
								type="text"
								{...register("evoThreeName", { required: "Name required", maxLength: 20 })}
						...
						<div className="input-wrapper">
							...
							<select
								...
								style={errorStyle(errors.region)}>
						...
						<div className="input-wrapper">
							...
							<select
								...
								style={errorStyle(errors.ability)}>
								<option value="" disabled>
									Select an ability
								</option>
						...
						<div className="input-wrapper">
							<h3>Move Set</h3>
							<select
								{...register("moveSet", { required: "Move is required" })}
								style={errorStyle(errors.moveSet)}>
								<option value="" disabled>
									Select a move
								</option>
						...
						<div className="input-wrapper">
							<h3>Upload Image</h3>
							<input type="file" {...register("image")} style={errorStyle(errors.image)} />
